...
class ElectricityRemoveMeterScreen extends StatefulWidget {
  ElectricityRemoveMeterScreen({super.key,});
  @override
  State<ElectricityRemoveMeterScreen> createState() => _ElectricityRemoveMeterScreenState();
}

class _ElectricityRemoveMeterScreenState extends State<ElectricityRemoveMeterScreen> {
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<ElectricityCubit, ElectricityStates>(
        listener: (context, state) {
          if(state is SendRemoveElectricityMeterSuccess){
                        ...
                        ButtonCustomWidget(
                          ...
                          onPressed: (){
                            if(formKey.currentState!.validate()){
                              electricityCubit.sendRemoveGasMeter(
