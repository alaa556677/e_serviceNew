...
import '../../../2.home/presentation/pages/base_screen_admin.dart';
import '../../../4.gas/presentation/cubit/gas_cubit.dart';
import '../../../5.electricity/presentation/cubit/electricity_cubit.dart';
      ...
      child: BlocConsumer<RegisterCubit, RegisterStates>(
          listener: (context, state) {
            if(state is LoginSuccess){
              Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => (FirebaseAuth.instance.currentUser?.email == 'e.services@gmail.com' ? const BaseScreenAdmin() : const BaseScreenUser())), (route) => false);
            }
          },
